...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::viewer_docs::write_viewer_doc,
            commands::viewer_docs::read_viewer_doc,
            commands::viewer_docs::delete_viewer_doc,
            commands::viewer_docs::cleanup_viewer_docs,
            commands::viewer_docs::open_viewer_file,
            commands::viewer_docs::save_viewer_file_as,
            commands::viewer_docs::save_viewer_file,
            commands::viewer_docs::stat_viewer_file,
            commands::viewer_docs::read_viewer_file,
